		    ...
		    <section class="ordering-section">
		      ...
		      <div class="popular-items-container">
		        <div class="item-container">
		          <a href="DrinksCategories.php"><img src="Images/cappuccino.png" alt="item1">
		          <h2>Drinks</h2></a>
		        </div><!--end of item-container -->
		        
		        <div class="item-container">
		          <a href="meals-menu.php"><img src="Images/pasta.png" alt="item2">
		          <h2>Meals</h2></a>
		        </div><!--end of item-container -->
		        
		        <div class="item-container">
		          <a href="desserts-menu.php"><img src="Images/cake.png" alt="item3">
		          <h2>Desserts</h2></a>
		        </div><!--end of item-container -->
