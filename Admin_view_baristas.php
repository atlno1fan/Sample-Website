						...
						<div class= "recent">
							...
							<div class="items-2">
								<table class="table-style">
									<thead>
										<th>
											<form action='Admin_view_baristas_script.php' method='post'>
											<button type='submit' name='add_user'>Add Barista</button>
											</form>
										</th>
										<th>User ID</th>
										<th>Barista Name</th>
									...
									<tbody>
										<?php 
											...
											$sql = "SELECT * FROM user_info WHERE Barista_status = 1";
											...
											if (mysqli_num_rows($result) > 0) {
					        						while($row = mysqli_fetch_array($result)){
					        							...
					        							echo "
					        							<tr>
					        							<td><form action='Admin_view_baristas_script.php' method='post'>
